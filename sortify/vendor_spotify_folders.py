# Vendored verbatim from https://github.com/mikez/spotify-folders (MIT),
# commit of 2026-05-10. Reads the desktop client's LevelDB rootlist cache.
# Do not edit — replace wholesale when syncing with upstream, and keep the
# wrapper in sortify/rootlist.py as the only caller.
#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
